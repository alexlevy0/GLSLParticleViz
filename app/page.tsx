...
const Duck = dynamic(() => import('@/components/canvas/Examples').then(mod => mod.Duck), {
  ssr: false,
})
    ...
    <>
      ...
      <div className="mx-auto flex w-full flex-col flex-wrap items-center p-12 md:flex-row  lg:w-4/5">
        ...
        <div className="w-full p-6 sm:w-1/2">
          ...
          <p className="mb-8 text-gray-600">
            3D Divs are renderer through the View component. It uses gl.scissor to cut the viewport
            into segments. You tie a view to a tracking div which then controls the position and
            bounds of the viewport. This allows you to have multiple views with a single, performant
            canvas. These views will follow their tracking elements, scroll along, resize, etc.
          </p>
        </div>
      </div>
    </>
